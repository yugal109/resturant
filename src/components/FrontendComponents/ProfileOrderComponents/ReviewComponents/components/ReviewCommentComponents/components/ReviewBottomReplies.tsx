...
const ReviewBottomReplies = () => {
  return (
    <>
      <View className=" items-center justify-center ">
        <View className="bg-white rounded-xl w-11/12 my-2 p-6 space-y-2">
          <View className="flex-row items-center justify-between">
            <Text className="text-primary text-2xl">Anonymous</Text>
...
export default ReviewBottomReplies;
