...
const LocationCardComponent = ({ location, navigation }: propsInterface) => {
  ...
  return (
    <View key={location.name} className="flex-row items-center px-4 pt-2 m-2">
      <Image
      ...
      <View className="flex-1">
        ...
        <View className="flex-row items-center ml-1">
          ...
          <Feather style={{ marginLeft: 10 }} name="credit-card" size={24} color="grey" />
